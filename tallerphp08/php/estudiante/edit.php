        ...
        <form id="formPersona" action="update.php" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="codigocurso" id="codigocurso">
                    ...
                    <?php $cursos = array('1'=> 'VUE', '2'=>'RUBY', '3'=>'PHP'); //estos son bloques compuestos por clave y valor, separados por comas 
                        foreach ($cursos as $k=>$v) { //el $v es value pero simplificado ?>
